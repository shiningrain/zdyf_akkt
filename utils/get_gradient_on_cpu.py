...
if __name__ == '__main__':
    ...
    parser.add_argument('--model','-m',default='./Test_dir/tmp/model.h5', help='model path')# 'auto' 'cust'
    parser.add_argument('--data_x','-dx',default='./Test_dir/tmp/x.npy', help='input')# 'auto' 'cust'
    parser.add_argument('--data_y','-dy',default='./Test_dir/tmp/y.npy', help='output')# 'auto' 'cust'
    parser.add_argument('--epoch','-ep',default=0, help='current training epoch')# 'auto' 'cust'
    parser.add_argument('--save_path','-sp',default='./Test_dir/tmp/gradient_weight.pkl', help='the path to save gradients and weights')# 'auto' 'cust'
